...
When we apply a nonlinear transform to a parameter with a uniform density, the density of the transform is not uniform. Let's take a look at $y=f(x)=e^x + \frac{x}{10}$. Look at how equal intervals of $x$ transform to unequal intervals of $y$.
